...
const Alert = ({ type, message, className = '' }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: `${baseClasses} ${typeClasses[type]} ${className}`, role: "alert", children: [jsxRuntime.jsx(Icon, { className: "w-5 h-5 mr-3", "aria-hidden": "true" }), jsxRuntime.jsx("span", { className: "sr-only", children: type }), jsxRuntime.jsx("span", { className: "text-sm font-medium", children: message })] }));
};
